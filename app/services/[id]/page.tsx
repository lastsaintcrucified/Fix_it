...
export default function ServiceDetailsPage({ params }: { params: { id: string } }) {
  ...
  const handleBookService = async () => {
    ...
    router.push(`/booking?service=${params.id}&date=${bookingDate}`)
  }
                ...
                <CardHeader>
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <CardDescription className="mt-1">{getCategoryLabel(service.category)}</CardDescription>
                    </div>
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Select a date to book this service</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{provider.businessName || "Service Provider"}</p>
                      </div>
                    </div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {provider.bio || "Professional service provider with years of experience in the industry."}
                    </p>
